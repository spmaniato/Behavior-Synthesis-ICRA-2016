...
%
\begin{abstract}
In this paper we present an \emph{end-to-end} approach for the automatic generation of software that implements reactive high-level robot behaviors.
...
Specifically, this paper focuses on Team ViGIR's software and \textsc{Atlas} humanoid robot.
The proposed approach has been implemented and open-sourced as a collection of Robot Operating System (ROS) packages.
We demonstrate the efficacy of our approach via experiments with \textsc{Atlas} in the lab.
