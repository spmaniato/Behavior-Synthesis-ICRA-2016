...
\author{Spyros Maniatopoulos$^{*}$, Philipp Schillinger$^{\dagger}$, Vitchyr Pong$^{*}$, David C. Conner$^{\ddagger}$, and Hadas Kress-Gazit$^{*}$% 	<-this % stops a space
\thanks{This work was supported by the Defense Advanced Research Projects Agency (DARPA) under Air Force Research Lab (AFRL) contract FA8750-12-C-0337 and by NSF CAREER CNS-0953365.}
...
Lastly, we automatically generate a state machine that instantiates the synthesized symbolic plan in software.
