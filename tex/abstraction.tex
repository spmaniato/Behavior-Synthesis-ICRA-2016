...
\subsection{Proposition Grounding / Mapping}

\todo[inline, caption = {Explicit ``solution" to Problem \ref{DiscreteAbstractionProblem}}]{Now that we have props, show what $\mathcal{D}_M$ looks like.}
