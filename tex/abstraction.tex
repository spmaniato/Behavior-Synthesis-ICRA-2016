...
\todo[inline, caption = {Mapping $\mathcal{D}_M$ is not properly defined}]{Define $\mathcal{D}_M$ in terms of FlexBE states as above or more generally in terms of primitive system capabilities?}
