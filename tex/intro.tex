...
The approach in \cite{Jon2015ICRA}, which utilizes \cite{Vasu2013ICRA} as is, deals with the related problem of uncertainty in a mobile robot's motion.
In terms of our approach to creating the formal specification, other options would have been asking the user to (i) write \textsc{ltl} formulas directly, (ii) write Structured English statements \cite{JFRKG2012ICRA}, or (iii) specify the task in natural language \cite{Lignos2015AURO}.
...
These included classical AI planners, such as STRIPS \cite{STRIPS1971AI} and PDDL \cite{PDDL1998TR}, optimization-based approaches under \textsc{ltl} constraints \cite{Wolff2014ICRA}, and synthesis from co-safe \textsc{ltl} specifications \cite{Kavraki2015ICRA}.
