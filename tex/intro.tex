...
\todo[inline, caption = {Dibs on graceful degradation in formal synthesis ?}]{Maybe say, ``To the best of our knowledge, this is the first time graceful degradation (or failure) is addressed in the context of formal synthesis" Is this true?}
