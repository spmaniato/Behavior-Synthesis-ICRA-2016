...
\todo[inline, caption = {Differentiate between control modes and memory}]{Symbol $m$ stands both for control modes $m \in \mathcal{M}$ and for memory propositions $m_g$. Use $\mu$ for memory?}
