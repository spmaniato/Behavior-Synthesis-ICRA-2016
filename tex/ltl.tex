...
\end{equation}
where $\varphi_\mathcal{M}^{none} = \bigwedge_{m \in \mathcal{M}} \lnot \pi_m$ being $\True$ stands for not activating any control mode transitions, i.e., staying in the same control mode.
