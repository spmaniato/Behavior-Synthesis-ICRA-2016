...
\todo[inline, caption = {Remove proposition ``deactivation" formula ?}]{Look like I might be able to remove this formula.}

\begin{equation}\label{PropositionDeactivationFormula}
	\LTLG \Big( \pi_y \wedge \bigvee \limits_{o \in Out(y)} \LTLX \pi_y^o \Rightarrow \LTLX \lnot \pi_y \Big)
\end{equation}
...
We now encode the connection between the activation and the possible outcomes of the system's actions, $a \in \mathcal{A}$.
