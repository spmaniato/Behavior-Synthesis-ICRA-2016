...
Team ViGIR based its software on the Robot Operating System (ROS).
...
Using the FlexBE framework, developers create ``state implementations", $\mathsf{s} \in \mathsf{S}$. % Maybe definitions?
...
%The composition of new state machines is historically carried out manually by an expert user.
