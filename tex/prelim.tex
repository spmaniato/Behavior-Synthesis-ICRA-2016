...
Team ViGIR has based its software on the ROS.
In this section, we highlight some elements of the software's design that are relevant to high-level control and synthesis.
