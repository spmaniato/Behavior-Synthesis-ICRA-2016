...
\end{myProblem}
\todo[inline, caption = {Mathematical properties of mapping $\mathcal{D}_M$}]{In practice, the mapping $\mathcal{D}_M$ is one-to-many. But we can treat it as one-to-one to simplify things for the paper.}
